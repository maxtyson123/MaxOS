...
\begin{DoxyCompactList}\small\item\em Destroy the Advanced Programmable Interrupt Controller object and frees the Local APIC and IO APIC. \end{DoxyCompactList}\item 
...
\item[\mbox{\hyperlink{todo__todo000024}{Todo}}]Should either handle all Local APICs or none (only boot core right now, others accessed per core directly which is inconsistent) \end{DoxyRefDesc}


Definition at line \mbox{\hyperlink{apic_8h_source_l00228}{228}} of file \mbox{\hyperlink{apic_8h_source}{apic.\+h}}.
...
Definition at line \mbox{\hyperlink{apic_8cpp_source_l00415}{415}} of file \mbox{\hyperlink{apic_8cpp_source}{apic.\+cpp}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00416\ :\ m\_pic\_master\_command\_port(0x20),}
\DoxyCodeLine{00417\ \ \ m\_pic\_master\_data\_port(0x21),}
\DoxyCodeLine{00418\ \ \ m\_pic\_slave\_command\_port(0xA0),}
\DoxyCodeLine{00419\ \ \ m\_pic\_slave\_data\_port(0xA1)}
\DoxyCodeLine{00420\ \{}
\DoxyCodeLine{00421\ }
\DoxyCodeLine{00422\ \ \ \ \ \textcolor{comment}{//\ Register\ this\ APIC}}
\DoxyCodeLine{00423\ \ \ \ \ \mbox{\hyperlink{classMaxOS_1_1Logger_a6fa276d92dbf0dd22dcab146f5c99da6}{Logger::INFO}}()\ <<\ \textcolor{stringliteral}{"{}Setting\ up\ APIC\(\backslash\)n"{}};}
\DoxyCodeLine{00424\ \ \ \ \ \mbox{\hyperlink{classMaxOS_1_1hardwarecommunication_1_1InterruptManager_a3a44cbeaa1d7ed616942bb2ef08ec863}{InterruptManager::active\_interrupt\_manager}}()-\/>\mbox{\hyperlink{classMaxOS_1_1hardwarecommunication_1_1InterruptManager_a5373148b2ed1db2126a5ea6324553df3}{set\_apic}}(\textcolor{keyword}{this});}
\DoxyCodeLine{00425\ }
\DoxyCodeLine{00426\ \ \ \ \ \textcolor{comment}{//\ Init\ the\ Local\ APIC}}
\DoxyCodeLine{00427\ \ \ \ \ \mbox{\hyperlink{classMaxOS_1_1Logger_a1df434c9cd82457b6830c0500731a601}{Logger::DEBUG}}()\ <<\ \textcolor{stringliteral}{"{}Initialising\ Local\ APIC\(\backslash\)n"{}};}
\DoxyCodeLine{00428\ \ \ \ \ m\_local\_apic\ =\ \textcolor{keyword}{new}\ \mbox{\hyperlink{classMaxOS_1_1hardwarecommunication_1_1LocalAPIC}{LocalAPIC}}();}
\DoxyCodeLine{00429\ }
\DoxyCodeLine{00430\ \ \ \ \ \textcolor{comment}{//\ Disable\ the\ legacy\ mode\ PIC}}
\DoxyCodeLine{00431\ \ \ \ \ \mbox{\hyperlink{classMaxOS_1_1Logger_a1df434c9cd82457b6830c0500731a601}{Logger::DEBUG}}()\ <<\ \textcolor{stringliteral}{"{}Disabling\ PIC\(\backslash\)n"{}};}
\DoxyCodeLine{00432\ \ \ \ \ disable\_pic();}
\DoxyCodeLine{00433\ }
\DoxyCodeLine{00434\ \ \ \ \ \textcolor{comment}{//\ Init\ the\ IO\ APIC}}
\DoxyCodeLine{00435\ \ \ \ \ \mbox{\hyperlink{classMaxOS_1_1Logger_a1df434c9cd82457b6830c0500731a601}{Logger::DEBUG}}()\ <<\ \textcolor{stringliteral}{"{}Initialising\ IO\ APIC\(\backslash\)n"{}};}
\DoxyCodeLine{00436\ \ \ \ \ m\_io\_apic\ =\ \textcolor{keyword}{new}\ \mbox{\hyperlink{classMaxOS_1_1hardwarecommunication_1_1IOAPIC}{IOAPIC}}(acpi);}
\DoxyCodeLine{00437\ \}}

\end{DoxyCode}


References \mbox{\hyperlink{interrupts_8cpp_source_l00392}{Max\+OS\+::hardwarecommunication\+::\+Interrupt\+Manager\+::active\+\_\+interrupt\+\_\+manager()}}, \mbox{\hyperlink{logger_8cpp_source_l00193}{Max\+OS\+::\+Logger\+::\+DEBUG()}}, \mbox{\hyperlink{logger_8cpp_source_l00171}{Max\+OS\+::\+Logger\+::\+INFO()}}, and \mbox{\hyperlink{interrupts_8cpp_source_l00308}{Max\+OS\+::hardwarecommunication\+::\+Interrupt\+Manager\+::set\+\_\+apic()}}.
...
Definition at line \mbox{\hyperlink{apic_8cpp_source_l00442}{442}} of file \mbox{\hyperlink{apic_8cpp_source}{apic.\+cpp}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00442\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{00443\ }
\DoxyCodeLine{00444\ \ \ \ \ \textcolor{comment}{//\ Free\ the\ memory}}
\DoxyCodeLine{00445\ \ \ \ \ \textcolor{keyword}{delete}\ m\_local\_apic;}
\DoxyCodeLine{00446\ \ \ \ \ \textcolor{keyword}{delete}\ m\_io\_apic;}
\DoxyCodeLine{00447\ \}}
...
Definition at line \mbox{\hyperlink{apic_8cpp_source_l00490}{490}} of file \mbox{\hyperlink{apic_8cpp_source}{apic.\+cpp}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00490\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{00491\ }
\DoxyCodeLine{00492\ \ \ \ \ \textcolor{keywordflow}{return}\ m\_io\_apic;}
\DoxyCodeLine{00493\ \}}

\end{DoxyCode}


Referenced by \mbox{\hyperlink{cpu_8cpp_source_l00527}{Max\+OS\+::system\+::\+CPU\+::find\+\_\+cores()}}.
...
Definition at line \mbox{\hyperlink{apic_8cpp_source_l00480}{480}} of file \mbox{\hyperlink{apic_8cpp_source}{apic.\+cpp}}.


\begin{DoxyCode}{0}
\DoxyCodeLine{00480\ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \{}
\DoxyCodeLine{00481\ }
\DoxyCodeLine{00482\ \ \ \ \ \textcolor{keywordflow}{return}\ m\_local\_apic;}
\DoxyCodeLine{00483\ \}}

\end{DoxyCode}


Referenced by \mbox{\hyperlink{clock_8cpp_source_l00144}{Max\+OS\+::drivers\+::clock\+::\+Clock\+::calibrate()}}, and \mbox{\hyperlink{cpu_8cpp_source_l00252}{Max\+OS\+::system\+::\+CPU\+::\+CPU()}}.
