...
\DoxyCodeLine{50 }
\DoxyCodeLine{51 }
\DoxyCodeLine{52     \textcolor{comment}{// TODO: This is done in assembly but would be nice to do here}}
\DoxyCodeLine{53 \textcolor{comment}{//    // Load the GDTR}}
\DoxyCodeLine{54 \textcolor{comment}{//    asm volatile("lgdt \%0" : : "m" (gdtr));}}
\DoxyCodeLine{55 \textcolor{comment}{//}}
\DoxyCodeLine{56 \textcolor{comment}{//    \_kprintf("Loaded GDT\(\backslash\)n");}}
\DoxyCodeLine{57 \textcolor{comment}{//}}
\DoxyCodeLine{58 \textcolor{comment}{//    // Reload the segment registers}}
\DoxyCodeLine{59 \textcolor{comment}{//    asm volatile("\(\backslash\)}}
\DoxyCodeLine{60 \textcolor{comment}{//        mov \$0x10, \%ax \(\backslash\)n\(\backslash\)}}
\DoxyCodeLine{61 \textcolor{comment}{//        mov \%ax, \%ds \(\backslash\)n\(\backslash\)}}
\DoxyCodeLine{62 \textcolor{comment}{//        mov \%ax, \%es \(\backslash\)n\(\backslash\)}}
\DoxyCodeLine{63 \textcolor{comment}{//        mov \%ax, \%fs \(\backslash\)n\(\backslash\)}}
\DoxyCodeLine{64 \textcolor{comment}{//        mov \%ax, \%gs \(\backslash\)n\(\backslash\)}}
\DoxyCodeLine{65 \textcolor{comment}{//        mov \%ax, \%ss \(\backslash\)n\(\backslash\)}}
\DoxyCodeLine{66 \textcolor{comment}{//        \(\backslash\)n\(\backslash\)}}
\DoxyCodeLine{67 \textcolor{comment}{//        pop \%rdi \(\backslash\)n\(\backslash\)}}
\DoxyCodeLine{68 \textcolor{comment}{//        push \$0x8 \(\backslash\)n\(\backslash\)}}
\DoxyCodeLine{69 \textcolor{comment}{//        push \%rdi \(\backslash\)n\(\backslash\)}}
\DoxyCodeLine{70 \textcolor{comment}{//    ");}}
\DoxyCodeLine{71 }
\DoxyCodeLine{72 }
\DoxyCodeLine{73     \mbox{\hyperlink{kprint_8h_ad0dbdc0814f8a967875ad592df02a663}{\_kprintf}}(\textcolor{stringliteral}{"Reloaded segment registers\(\backslash\)n"});}
\DoxyCodeLine{74 }
\DoxyCodeLine{75 \}}
