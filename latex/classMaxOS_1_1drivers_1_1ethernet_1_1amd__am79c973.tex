...
\DoxyCodeLine{71     sendBufferDescr = (BufferDescriptor*)(MemoryManager::kmalloc((\textcolor{keyword}{sizeof}(BufferDescriptor) * 8) + 15));  \textcolor{comment}{// Allocate memory for 8 buffer descriptors}}
\DoxyCodeLine{72     initBlock.sendBufferDescrAddress = (uint32\_t)sendBufferDescr;}
\DoxyCodeLine{73 }
\DoxyCodeLine{74     recvBufferDescr = (BufferDescriptor*)(MemoryManager::kmalloc((\textcolor{keyword}{sizeof}(BufferDescriptor) * 8) + 15));  \textcolor{comment}{// Allocate memory for 8 buffer descriptors}}
