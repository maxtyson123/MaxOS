	...
	namespace filesystem {
		...
		namespace partition {
			...
			typedef struct PACKED PartitionTableEntry {
				...
				uint16_t start_cylinder: 10;        ///< The starting cylinder of the partition

				uint8_t type;                       ///< The partition type (see PartitionType enum)

				uint8_t end_head;                   ///< The last head of the partition
				uint8_t end_sector: 6;              ///< The last sector of the partition
				uint16_t end_cylinder: 10;          ///< The last cylinder of the partition
			...
			typedef struct PACKED MasterBootRecord {
				...
				uint16_t unused;                                ///< Reserved (usually zero)

				PartitionTableEntry primary_partition[4];       ///< The partition table entries
			 ...
			 * @brief Handles mounting of partitions documented in an MSDOS partition table
			 *
