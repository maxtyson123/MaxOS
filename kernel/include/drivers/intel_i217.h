...
#ifndef MAXOS_DRIVERS_INTEL_I127_H
#define MAXOS_DRIVERS_INTEL_I127_H
...
namespace maxOS{
    ...
    namespace drivers {
        ...
        class RawDataHandler_temp{

        protected:
            intel_i217* backend;
        public:
            RawDataHandler_temp(intel_i217* backend);
            ~RawDataHandler_temp();
        ...
        class intel_i217 : public Driver, public hardwarecommunication::InterruptHandler {
            ...
            RawDataHandler_temp* handler;     // The handler for the received data

        public:

            intel_i217(hardwarecommunication::PeripheralComponentInterconnectDeviceDescriptor* deviceDescriptor, hardwarecommunication::InterruptManager* interruptManager);         // Constructor. takes as a parameter a pointer to an object that encapsulate all he PCI configuration data of the device
            ...
            void SetHandler(RawDataHandler_temp* handler);
...
#endif //MAXOS_DRIVERS_INTEL_I127_H
