...
#ifndef MAXOS_CONSOLE_VESABOOTCONSOLE_H
...
namespace MaxOS::console {
	 ...
	 */
	class VESABootConsole :  public Console {
		...
		public:
			...
			ConsoleStream* cout;    ///< The boot console output stream
			void finish() const;
...
#endif //MAXOS_CONSOLE_VESABOOTCONSOLE_H
