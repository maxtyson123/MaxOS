...
namespace MaxOS::console {
	 ...
	 * @brief Handles the printing of characters and strings to the screen using a framebuffer
	 */
	class FramebufferConsole :  public Console {
		...
		private:
			...
			inline static multiboot_tag_framebuffer* s_framebuffer_info = nullptr;
			uint8_t m_framebuffer_bpp;
			uint16_t m_framebuffer_pitch;
			uint64_t* m_framebuffer_address;
			size_t m_framebuffer_size;

			static void put_pixel(uint32_t x, uint32_t y, uint32_t col);

		public:
			explicit FramebufferConsole(multiboot_tag_framebuffer *framebuffer_info);
			~FramebufferConsole();
