...
#ifndef MAXOS_MULTITHREADING_H
#define MAXOS_MULTITHREADING_H
...
namespace maxOS{
    ...
    class Thread
    {
        ...
        public:
            ...
            void init(GlobalDescriptorTable *gdt, void entrypoint());
            ~Thread();
    };
    ...
    class ThreadManager
    {
        ...
        public:
            ThreadManager();
            ThreadManager(GlobalDescriptorTable *gdt);
            ~ThreadManager();
